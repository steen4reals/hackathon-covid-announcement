...
VALUES
    ...
    ('2021-03-08', 'Stage 1a', 'Care', 'Can visit care homes/supported living, with PPE'),
    ...
    ('2021-03-29', 'Stage 1b', 'Health', 'Formal sports matches can restart'),
    ('2021-03-29', 'Stage 1b', 'Ceremonies', 'Wedding events (limit 15 people)'),
    ('2021-03-29', 'Stage 1b', 'Health', 'Outdoor sport facilties reopen'),
    ...
    ('2021-04-12', 'Stage 2', 'Services', 'Hairdressers, salons, spas reopen'),
    ('2021-04-12', 'Stage 2', 'Ceremonies', 'Wedding events (limit 15 people)'),
    ('2021-04-12', 'Stage 2', 'Families', 'child indoor activities reopen (15 adult limit)'),
    ('2021-04-12', 'Stage 2', 'Travel', 'Domestic holidays within UK permitted'),
    ...
    ('2021-05-17', 'Stage 3', 'Families', 'child play areas reopen'),
    ('2021-05-17', 'Stage 3', 'Travel', 'Hotels, hostels, B&Bs reopen for non-emergency use'),
    ('2021-05-17', 'Stage 3', 'Travel', 'International leisure travel to resume'),
    ...
    ('2021-06-21', 'Stage 4', 'Entertainment', 'Arenas reopen (full capacity)');